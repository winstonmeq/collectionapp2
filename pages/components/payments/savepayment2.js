import {
  ...
  const Savepayment2 = ({transacId, or_id, orGenId, orNumber,orNumber2, orFrom, orTo, orTo2, orFund,orType, customerName, amount}) => {
          ...
          const handleSavePayment = async () => {
            ...
            try {
             ...
             if(response != null){
              ...
              //this is a feedback function to save data to addCedula
